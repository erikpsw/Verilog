...
set rc [catch {
  read_adc ../../keyboard.adc
  optimize_rtl
  report_area -file display_rtl.area
  export_db {display_rtl.db}
} RESULT]
if {$rc} {
  step_error opt_rtl
  return -code error $RESULT
...
set rc [catch {
  read_sdc
  optimize_gate -maparea display_gate.area
  legalize_phy_inst
  export_db {display_gate.db}
} RESULT]
if {$rc} {
  step_error opt_gate
  return -code error $RESULT
