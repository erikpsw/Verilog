...
set rc [catch {
  ...
  import_db {../syn_1/keyboard_gate.db}
  read_sdc
  place
  export_db {keyboard_place.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  route
  report_area -io_info -file keyboard_phy.area
  export_db {keyboard_pr.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  export_bid keyboard_inst.bid
  bitgen -bit "keyboard.bit" -unused_io_status pulldown
} RESULT]
if {$rc} {
  step_error bitgen
  return -code error $RESULT
