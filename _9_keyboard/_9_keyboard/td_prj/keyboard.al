...
<Project Version="3" Minor="2" Path="D:/fpga_class/prj/_9_keyboard/td_prj">
    ...
    <Source_Files>
        <Verilog>
            <File Path="../src/Digitron_TimeDisplay_module.v">
                <FileInfo>
            ...
            <File Path="../src/keyboard_instance.v">
                <FileInfo>
                    <Attr Name="UsedInSyn" Val="true"/>
                    <Attr Name="UsedInP&R" Val="true"/>
                    <Attr Name="BelongTo" Val="design_1"/>
            ...
            <File Path="../src/keyboard_instance_watcherInst.v">
                <FileInfo>
