...
set rc [catch {
  open_project {hello.prj}
  import_device eagle_s20.db -package EG4S20BG256
  import_db {../syn_1/hello_gate.db}
  read_sdc
  place
  export_db {hello_place.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  route
  report_area -io_info -file hello_phy.area
  export_db {hello_pr.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  export_bid hello_inst.bid
  bitgen -bit "hello.bit" -unused_io_status pulldown
} RESULT]
if {$rc} {
  step_error bitgen
  return -code error $RESULT
